...
function mapRestErrorToSDKError(error: RestError): SDKError {
    switch (error.statusCode) {
        ...
        case 404:
            return new SDKError(ErrorCodes.Data.NotFound, 'Requested Ressource does not exist');
        case 500:
        case 503:
            return new SDKError(ErrorCodes.General.Issue, 'Internal Server Error occured during processing request');
        default:
            return new SDKError(ErrorCodes.General.Unknown, `Unkown Error ${error.message} occured`);
    }
}

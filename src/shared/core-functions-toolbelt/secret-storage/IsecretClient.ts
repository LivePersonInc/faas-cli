...
export interface ISecretClient {
     ...
     */
    readSecret(key: string, options?: Partial<SecretRequestOptions>): Promise<SecretEntry>;
    /**
     ...
     */
    updateSecret(updatedSecret: SecretEntry, options?: Partial<SecretRequestOptions>): Promise<SecretEntry>;
}

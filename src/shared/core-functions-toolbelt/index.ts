...
import type { SecretClientOptions, SecretEntry } from './secret-storage/types.js';
...
export const globalSecretCache: ICache<string, SecretEntry> = new SecretCache(defaultSecretClientOptions.cache);
/**
